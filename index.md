...
decades [[zhou06modern]](zhou06modern), and has also gained increasing attention from both academic and industry for its broad applications. In this tutorial, we plan to divide and introduce IQA in the following four parts:
...
Several subjective methodologies have been standardized in the ITU-R and ITU-T recommendations [[bt2002methodology]](bt2002methodology), which can be broadly categorized into single-stimulus, double-stimulus, and multiple-stimulus
...
example, the LIVE dataset [[sheikh2006statistical]](sheikh2006statistical) marks the switch from
distortion-specific to general-purpose IQA. The CSIQ dataset
[[larson2010most]](larson2010most) enables cross-dataset comparison. The TID2013
dataset [[ponomarenko2013color]](ponomarenko2013color) and its successor
KADID-10K [[lin2019kadid]](lin2019kadid) expose the difficulty of IQA methods in
generalizing to different distortion types. The Waterloo Exploration
Database [[ma17waterloo]](ma17waterloo) tests model robustness to diverse content
variations of natural scenes. The LIVE Challenge
Database [[ghadiyaram2015massive]](ghadiyaram2015massive) probes the synthetic-to-real
generalization, which is further evaluated by the KonIQ-10K
[[hosu2020koniq]](hosu2020koniq) and SPAQ [[fang20perceptual]](fang20perceptual) datasets. At the end of
...
of signal processing for more than $50$ years [[wang2009mean]](wang2009mean). We will
...
(SSIM) index [[wang04image]](wang04image), a award-winning and widely adopted
...
identity of indiscernibles[^1], which has a strong implication that they
...
statistics (NSS) [[wang2011reduced]](wang2011reduced). The underlying assumption is that a
...
[[mittal13making]](mittal13making), which has began to show its potentials in
...
-   Unified learning for NR-IQA from multiple IQA databases
    ...
    scale realignment [[zhang21uncer]](zhang21uncer);

-   Active learning for NR-IQA by failure identification and model
    rectification [[wang2021troubleshooting]](wang2021troubleshooting);
...
-   Continual learning for NR-IQA, where the model evolves with new data
    ...
    [[zhang2021continual]](zhang2021continual).
...
-   Maximum differentiation (MAD) competition [[wang2008maximum]](wang2008maximum),
    automatically synthesizing images that are likely to falsify the IQA
    model in question;

-   Group MAD (gMAD) competition [[ma20group]](ma20group), a discrete instantiation
    of MAD that is more efficient and controllable;

-   Eigen-distortion analysis [[berardino2017eigen]](berardino2017eigen), a method for
...
-   Comparison of IQA models for perceptual optimization of image
    processing systems [[ding21comparison]](ding21comparison).
...
particularities [[wang2016objective]](wang2016objective). Subject to the time constraint, we
plan to present a few demonstrating examples, including

-   High-dynamic-range imaging [[laparra2016perceptual]](laparra2016perceptual), where the input
    and output images have different bit depths;

-   Image fusion [[liu2011objective]](liu2011objective), where input and output have
    different numbers of images;

-   Color-to-gray conversion [[ma2015objective]](ma2015objective) and colorization, where
    input and output images have different color channels;

-   Image retargeting [[fang2014objective]](fang2014objective), where input and output
    images have different spatial resolutions;

-   Stereoscopic images [[wang15quality]](wang15quality), where binocular vision should
    be modeled;

-   Omnidirectional images [[sui21perceptual]](sui21perceptual), where viewing behaviors
    may be indispensable for quality assessment;

-   Screen content images [[fang17objective]](fang17objective), where non-natural image
...
### References
<a id="berardino2017eigen">
 A. Berardino, J. Ballé, V. Laparra,and E. P.
Simoncelli. 2017. Eigen-distortions of hierarchical representations.
*arXiv preprint arXiv:1710.02266* (2017).
</a>

<a id="bt2002methodology">
 RECOMMENDATION ITU-R BT. 2002. Methodology for the
subjective assessment of the quality of television pictures.
*International Telecommunication Union* (2002).
</a>

<a id="ding21comparison">
 K. Ding, K. Ma, S. Wang,and E. P. Simoncelli. 2021.
Comparison of full-reference image quality assessment models for
optimization of image processing systems. *International Journal of
Computer Vision* 129, 4 (2021), 1258--1281.
</a>

<a id="fang17objective">
 Y. Fang, J. Yan, J. Liu, S. Wang, Q. Li,and Z. Guo.
2017. Objective quality assessment of screen content images by
uncertainty weighting. *IEEE Transactions on Image Processing* 26, 4
(2017), 2016--2027.
</a>

<a id="fang2014objective">
 Y. Fang, K. Zeng, Z. Wang, W. Lin, Z. Fang,and C.-W.
Lin. 2014. Objective quality assessment for image retargeting based on
structural similarity. *IEEE Journal on Emerging and Selected Topics in
Circuits and Systems* 4, 1 (2014), 95--105.
</a>

<a id="fang20perceptual">
 Y. Fang, H. Zhu, K. Ma, Z. Wang,and S. Li. 2020.
...
<a id="berardino2017eigen">
ghadiyaram2015massive D. Ghadiyaramand A. C. Bovik. 2015. Massive online
crowdsourced study of subjective and objective picture quality. *IEEE
Transactions on Image Processing* 25, 1 (2015), 372--387.
</a>

<a id="hosu2020koniq">
 V. Hosu, H. Lin, T. Sziranyi,and D. Saupe. 2020. :An
ecologically valid database for deep learning of blind image quality
assessment. *IEEE Transactions on Image Processing* 29 (2020),
4041--4056.
</a>

<a id="laparra2016perceptual">
 V. Laparra, J. Ballé, A. Berardino,and E. P.
Simoncelli. 2016. Perceptual image quality assessment using a
normalizedLaplacian pyramid. *Electronic Imaging* 2016, 16 (2016), 1--6.
</a>

<a id="larson2010most">
 E. C. Larsonand D. M. Chandler. 2010. Most apparent
distortion:Full-reference image quality assessment and the role of
strategy. *Journal of Electronic Imaging* 19, 1 (2010), 1--21.
</a>

<a id="lin2019kadid">
 H. Lin, V. Hosu,and D. Saupe. 2019. :A large-scale
artificially distorted IQA database. In *2019 Eleventh International
Conference on Quality of Multimedia Experience*. 1--3.
</a>

<a id="liu2011objective">
 Z. Liu, E. Blasch, Z. Xue, J. Zhao, R. Laganiere,and W.
Wu. 2011. Objective assessment of multiresolution image fusion
algorithms for context enhancement in night vision:A comparative study.
*IEEE Transactions on Pattern Analysis and Machine Intelligence* 34, 1
(2011), 94--109.
</a>

<a id="ma20group">
 K. Ma, Z. Duanmu, Z. Wang, Q. Wu, W. Liu, H. Yong, H. Li,and
L. Zhang. 2020. Group maximum differentiation competition:Model
comparison with few samples. *IEEE Transactions on Pattern Analysis and
Machine Intelligence* 42, 4 (2020), 851--864.
</a>

<a id="ma17waterloo">
 K. Ma, Z. Duanmu, Q. Wu, Z. Wang, H. Yong, H. Li,and L.
Zhang. 2017. Waterloo exploration database:New challenges for image
quality assessment models. *IEEE Transactions on Image Processing* 26, 2
(2017), 1004--1016.
</a>

<a id="ma2015objective">
 K. Ma, T. Zhao, K. Zeng,and Z. Wang. 2015. Objective
quality assessment for color-to-gray image conversion. *IEEE
Transactions on Image Processing* 24, 12 (2015), 4673--4685.
</a>

<a id="mittal13making">
 A. Mittal, R. Soundararajan,and A. C. Bovik. 2013. Making
a "completely blind" image quality analyzer. *IEEE Signal Processing
Letters* 20, 3 (2013), 209--212.
</a>

<a id="ponomarenko2013color">
 N. Ponomarenko, O. Ieremeiev, V. Lukin, K.
Egiazarian, L. Jin, J. Astola, B. Vozel, K. Chehdi, M. Carli, F.
Battisti,et al 2013. Color image databaseTID2013:Peculiarities and
preliminary results. In *European Workshop on Visual Information
Processing*. 106--111.
</a>

<a id="sheikh2006statistical">
 H. R. Sheikh, M. F. Sabir,and A. C. Bovik. 2006. A
statistical evaluation of recent full reference image quality assessment
algorithms. *IEEE Transactions on Image Processing* 15, 11 (2006),
3440--3451.
</a>

<a id="sui21perceptual">
 X. Sui, K. Ma, Y. Yao,and Y. Fang. 2021. Perceptual
quality assessment of omnidirectional images as moving camera videos.
*IEEE Transactions on Visualization and Computer Graphics* (2021),
1--11.
</a>

<a id="wang15quality">
 J. Wang, A. Rehman, K. Zeng, S. Wang,and Z. Wang. 2015.
Quality prediction of asymmetrically distorted stereoscopic3D images.
*IEEE Transactions on Image Processing* 24, 11 (2015), 3400--3414.
</a>

<a id="wang2016objective">
 Z. Wang. 2016. Objective image quality
assessment:Facing the real-world challenges. *Electronic Imaging* 2016,
13 (2016), 1--6.
</a>
...
<a id="zhou06modern">
Z. Wangand A. C. Bovik. 2006. *Modern Image Quality
Assessment*. Morgan & Claypool.
</a>

<a id="wang2009mean">
 Z. Wangand A. C. Bovik. 2009. Mean squared error:Love it or
leave it?A new look at signal fidelity measures. *IEEE Signal Processing
Magazine* 26, 1 (2009), 98--117.
</a>

<a id="wang2011reduced">
 Z. Wangand A. C. Bovik. 2011. Reduced-and no-reference
image quality assessment. *IEEE Signal Processing Magazine* 28, 6
(2011), 29--40.
</a>

<a id="wang2008maximum">
 Z. Wangand E. P. Simoncelli. 2008. Maximum
differentiation (MAD) competition:A methodology for comparing
computational models of perceptual quantities. *Journal of Vision* 8, 12
(2008), 8.1--8.13.
</a>
...
<a id="zhang2021continual">
 W. Zhang, D. Li, C. Ma, G. Zhai, X. Yang,and K. Ma.
2021a. Continual learning for blind image quality assessment. *arXiv
preprint arXiv:2102.09717* (2021).
</a>

<a id="zhang21uncer">
 W. Zhang, K. Ma, G. Zhai,and X. Yang. 2021b.
...
##### Note
[^1]: Give an FR-IQA model $D(\cdot)$, where a lower score indicating
    better predicted quality with a minimum of zero, and two images
    $x,y$, the identity of indiscernibles refers to
